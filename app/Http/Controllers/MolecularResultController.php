    ...
    public function store(StoreMolecularResultRequest $request)
    {
        ...
        foreach ($request->results as $result) {
            ...
            MolecularResult::create([
                ...
                // 'result' => $result['pathogen_name_dengue'] ?? null,
                // 'result' => $result['pathogen_name_chikungunya'] ?? null,
                // 'result' => $result['pathogen_name_zika'] ?? null,
                // 'result' => $result['dengue_result'] ?? null,
                // 'result' => $result['chikungunya_result'] ?? null,
                // 'result' => $result['zika_result'] ?? null,
